PLANNER_PROMPT = (
    ...
    "You role in the system is to create a step by step plan for your colleagues that would help accomplish the user's request."
    "Your colleague SUPERVISOR is going to provide you with user's request."
    "### TASK ###"
